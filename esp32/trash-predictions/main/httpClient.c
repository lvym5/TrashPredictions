...
void contactReportEndpoint(uint32_t* data) {
    esp_http_client_config_t reportEndpointConfig = {
    ...
    esp_http_client_handle_t client = esp_http_client_init(&reportEndpointConfig);

    /* set headers */
    esp_http_client_set_header(client, "Content-Type", "application/json");
    esp_http_client_set_header(client, "Authorization", "Bearer 2829c578c2f4525e7df6715bbabaafba");
